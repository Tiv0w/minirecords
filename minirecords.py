...
class Record(object):
    ...
    def keys(self):
        """Return the list of column names from the query."""
        return self._keys

    def values(self):
        """Return the list of values from the query."""
        return self._values
    ...
    def get(self, key, default=None):
        """Return the value for a given key, or default."""
        try:
            return self[key]
        except KeyError:
            return default
...
class Connection(object):
    ...
    def __init__(self, connection):
        self._conn: sq.Connection = connection
